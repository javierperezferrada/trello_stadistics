...
def run_tests():
    CONSUMER_KEY = '8924e92319a65ea776ab9662041f57d8'
    CONSUMER_SECRET = '2c6c0b1f0497193bc7dcb5a1aff9488eda832b461622a726d7e7c5ab761aac5e'

    CALLBACK_BASE = '127.0.0.1'
    SERVER_URL = 'https://api.trello.com'

    DEFAULT_API_RESOURCE = '/member/me/boards'
    VERIFIER = None
    ...
    service = rauth.OAuth1Service(
           ...
           request_token_url=SERVER_URL + '/1/OAuthGetRequestToken',
           access_token_url=SERVER_URL + '/1/OAuthGetAccessToken',
           authorize_url=SERVER_URL + '/1/OAuthAuthorizeToken',
           base_url=SERVER_URL + '/1/auth2')
